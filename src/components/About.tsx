  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        <div>
          <img src={logo} alt={companyName} className="w-[200px] h-[200px]" />
        </div>
        ...
        <div className="flex items-center gap-x-8 mt-6 h-8">
          ...
          >
            <svg
              className="fill-current text-white dark:text-white hover:text-primary"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <div className="flex items-center mt-6">
          <p className="mt-6 text-xs lg:text-sm leading-none text-white dark:text-gray-50">
